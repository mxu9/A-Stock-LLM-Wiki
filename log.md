...
| 2026-08-28 | 创建 [[silver]] 概念页 + 3个白银entity（000603盛达资源/000426兴业银锡/002716湖南白银）| 用户报告摄入 temp/白银.md |

## 2026-08-29
- 新建 `entities/000333.md`（美的集团）：基于用户PDF《美的集团全面投资分析》(2026/8/28)+mx-data/mx-search双源交叉验证（16项核验：13项一致，3项口径差异已标注修正——PE口径/经营现金流/资产负债率期数/库卡份额）。含人形机器人+液冷主题章节、分红回购全景、券商观点、多空分析。index.md 同步（230 entities）。

## 2026-08-29（二）
- 新建 `concepts/drmos.md`：基于用户PDF《DrMOS行业全面分析》+15项交叉验证（6✅/5❌修正/4方向采信）。核心修正：杰华特市值实际538.5亿（PDF写314.64亿）、南芯PE(TTM)实际220x（PDF写45x估值洼地，失实）、市场规模CAGR自相矛盾。产业框架（85%海外/国产7%/license到期窗口）多源成立。aidc-power加三次电源小节、power-semiconductor加关联。
